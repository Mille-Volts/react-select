...
var Select = _react2['default'].createClass({
	...
	componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
		...
		var requireInputValueUpdate = !this.state.isFocused && !this.state.isPseudoFocused && (this.props.disabled != nextProps.disabled || this.props.searchable != nextProps.searchable || this.props.multi != nextProps.multi || this.props.value != nextProps.value || this.props.options != nextProps.options);
